...
import Notes from './view-entry/notes'
import Tasks from './view-entry/task-list'

import AvatarViewer from '../../components/avatarViewerModal'

export default class ProfileViewerPage extends Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <View style={style.screen}>
        ...
        <TabNav screenProps={{task: this.props.navigation.getParam('task', '-'), nav: this.props.navigation}}/>
      </View>
    )
  }
}
